...
# by n to get the value as a proportion. Use the following value as 
# p-hat in part 2a. 
rbinom(1, n, p)/n
...
# population proportion p=0.101, we'll use a logical argument in 
# combination with the mean function. 
